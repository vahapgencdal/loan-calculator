...
@Service
@Qualifier("vehicleLoanService")
public class VehicleLoanServiceImpl implements LoanService {
    Logger LOGGER = LoggerFactory.getLogger(VehicleLoanServiceImpl.class);
