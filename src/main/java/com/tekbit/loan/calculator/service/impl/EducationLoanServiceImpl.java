...
@Service
@Qualifier("educationLoanService")
public class EducationLoanServiceImpl implements LoanService {
    Logger LOGGER = LoggerFactory.getLogger(EducationLoanServiceImpl.class);
