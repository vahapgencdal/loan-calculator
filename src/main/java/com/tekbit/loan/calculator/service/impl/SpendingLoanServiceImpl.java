...
@Service
@Qualifier("spendingLoanService")
public class SpendingLoanServiceImpl implements LoanService {

    Logger LOGGER = LoggerFactory.getLogger(SpendingLoanServiceImpl.class);
