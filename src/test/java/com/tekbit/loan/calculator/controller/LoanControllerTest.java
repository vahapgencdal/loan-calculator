...
public class LoanControllerTest {
    ...
    void calculateMonthlyPayment() throws Exception {
        ...
        when(loanService.calculateMonthlyPayment(any())).thenReturn(loanResponse);
    ...
    @Test
    void getSavedMonthlyPayments() throws Exception {
        ...
        when(loanService.getSavedMonthlyPayments(any())).thenReturn(loanListResponses);
